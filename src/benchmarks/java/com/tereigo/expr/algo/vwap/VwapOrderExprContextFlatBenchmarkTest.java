...
// Flat-AST evaluator variant of VwapOrderExprContextBenchmarkTest - same setup, same expression,
// so throughput numbers are directly comparable. Uses FlatExprEvaluatorFactory
// (com.tereigo.expr.impl.experimental) instead of ExprEvaluatorFactory.
public class VwapOrderExprContextFlatBenchmarkTest {
