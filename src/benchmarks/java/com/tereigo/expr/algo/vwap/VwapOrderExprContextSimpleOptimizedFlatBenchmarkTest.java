...
// Flat-AST evaluator variant of VwapOrderExprContextSimpleOptimizedBenchmarkTest - same setup,
// same expression, so the printed timings are directly comparable. This class is just for
// debugging purposes (see the original for the real JMH benchmark).
class VwapOrderExprContextSimpleOptimizedFlatBenchmarkTest {
