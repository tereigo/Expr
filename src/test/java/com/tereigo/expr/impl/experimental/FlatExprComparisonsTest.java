...
import com.tereigo.expr.impl.ExprComparisonsTest;

import java.util.Map;

// Re-runs every test in ExprComparisonsTest against the experimental flat-AST evaluator
// (see com.tereigo.expr.impl.experimental) instead of the tree-walking one.
public class FlatExprComparisonsTest extends ExprComparisonsTest {
