...
import com.tereigo.expr.impl.FalconDomainTest;

import java.util.Map;

// Re-runs every test in FalconDomainTest against the experimental flat-AST evaluator
// (see com.tereigo.expr.impl.experimental) instead of the tree-walking one.
public class FlatFalconDomainTest extends FalconDomainTest {
